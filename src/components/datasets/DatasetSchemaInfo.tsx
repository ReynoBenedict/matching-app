...
export function DatasetSchemaInfo({ isOpen, onClose }: DatasetSchemaInfoProps) {
  ...
  return (
    <Modal
      ...
      subtitle="Kolom yang dikenal sistem untuk seluruh sumber dataset BPS."
        ...
        <div className="space-y-lg">
          ...
          <div className="grid grid-cols-2 gap-md">
            ...
            <div className="bg-secondary-fixed p-md rounded-lg">
              <p className="text-label-md text-on-surface-variant uppercase mb-xs">Legacy Fields</p>
          ...
          <div>
            <h3 className="font-headline-sm text-on-surface mb-md flex items-center gap-sm">
              ...
              Additional Known Fields ({DATASET_OPTIONAL_FIELDS.length})
            </h3>
            <div className="space-y-sm">
          ...
          <div className="bg-surface-container-high border-l-4 border-secondary p-md rounded">
            <p className="text-body-sm text-on-surface">
              <span className="font-semibold">Note:</span> Kolom dapat berbeda antar dataset. Kolom yang dikenal sistem akan dipakai bila tersedia; kolom lain tetap disimpan dan dapat digunakan untuk matching melalui pemetaan kolom.
